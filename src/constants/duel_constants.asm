...
DEF PLAYED_SUPPORTER_THIS_TURN_F    EQU 2
...
DEF DUELVARS_ARENA_CARD_RETREAT_AID           EQUS "LOW(wPlayerArenaCardRetreatAid)"         ; e6
...
; New
DEF SUBSTATUS2_REDUCE_BY_X0	  EQU $0c
DEF SUBSTATUS2_RC_INCREASED_1	  EQU $0d
DEF SUBSTATUS2_RC_INCREASED_2	  EQU $0e
DEF SUBSTATUS2_REDUCE_BY_30	  EQU $0f
