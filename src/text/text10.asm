...
ThrashDescription:
	...
	line "Nidoking does 10 damage to itself."
	done
...
ToxicDescription:
	text "Put Poison counters on the Defending"
	line "Pokémon until it has 2 Poison"
	line "counters on it."
	done
...
FireBlastDescription:
	text "You may discard up to 3 cards from"
	line "your hand as you use this attack."
	line "This attack does 10 more damage"
	line "for each card discarded this way."
	done
