...
TextOffsets::
	...
	textpointer Discard1EnergyDescription                                   ; 0x08d5
	...
	textpointer PowderFrenzyName
	textpointer PsnAndSlpDescription
	textpointer FlipUntil2TailsText
	textpointer OppRCis1MoreDescription
	textpointer OppRCis2MoreDescription
	textpointer PoisonNeedleName
	textpointer Flip10x2MoreDamageDescription
