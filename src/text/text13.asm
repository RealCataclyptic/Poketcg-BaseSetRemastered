...
FlipUntil2TailsText:
	text "Flip coins until you hit"
	line "tails twice!"
	done

OppRCis1MoreDescription:
	text "During your opponent's next turn,"
	line "the defending Pokémon's retreat cost"
	line "is <COLORLESS> more."
	done

OppRCis2MoreDescription:
	text "During your opponent's next turn,"
	line "the defending Pokémon's retreat cost"
	line "is <COLORLESS><COLORLESS> more."
	done
...
SwiftDescription:
	...
	line "affected by weakness, resistance,"
