...
IncreaseRCby1EffectCommands: ; does ai understand this!?
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, IncreaseRCBy1Effect
	db $00

IncreaseRCby2EffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, IncreaseRCBy2Effect
	db $00

Do20Plus2x10DamageEffectCommands:
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, MayAdd2x10DamageEffect
	dbw EFFECTCMDTYPE_AI, MayAdd2x10DamageAIEffect
	db $00
...
UnaffectedByEverythingEffectCommands:
	db  $00
