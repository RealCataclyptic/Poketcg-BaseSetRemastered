...
IncreaseRCBy2Effect:
	ld a, SUBSTATUS2_RC_INCREASED_2
	jp ApplySubstatus2ToDefendingCard

MayAdd2x10DamageEffect:
	ld a, 2
	call Plus10DamagePerHeads_TossCoins
	jp AddToDamage

MayAdd2x10DamageAIEffect:
	ld a, (20 + 40) / 2
	lb de, 20, 40
	jp SetExpectedAIDamage

Discard1AttachedEnergy_PlayerSelection:
	xor a
...
Heal_RemoveDamageEffect:
	ldh [hAIPkmnPowerEffectParam], a ; coinflip removed?
...
.done
; flag the Pokemon Power as being used regardless of coin outcome ; maybe add healing anim?
	ldh a, [hTemp_ffa0]
	add DUELVARS_ARENA_CARD_FLAGS
	get_turn_duelist_var
	set USED_PKMN_POWER_THIS_TURN_F, [hl]
